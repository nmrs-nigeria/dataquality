...
public class CohortMaster {
    ...
    public void loadCohortDictionary() {
        ...
        initialARTRegimenLast6Months=buildCohortByObsDate(targetConceptArr, ART_COMMENCEMENT_FORM_ID, startDateTime.toDate(), endDateTime.toDate());
        newlyStartedARTWithInitialARTRegimenLast6Months=interset(newlyStartedARTLast6MonthsCohort, initialARTRegimenLast6Months);
